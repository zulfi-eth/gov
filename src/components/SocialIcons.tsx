  ...
  return (
    ...
    >
      <div className='flex gap-x-4 md:gap-x-5'>
        ...
        >
          <img src='/icons/discord.svg' className='h-8' alt='discord' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <img src='/icons/twitter.svg' className='h-8' alt='twitter' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <img src='/icons/github.svg' className='h-8' alt='github' />
        </a>
      </div>
    </div>
  );
